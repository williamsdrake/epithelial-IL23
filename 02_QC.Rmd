...
```{r load datasets}
combined <- readRDS(file = "/home/williamsdrw/updatedAtlas-hu/04_data_objects/01_SoupX_objects/2023-04-19_015-allWithMeta.RDS")
```
...
combined <- Add_Mito_Ribo_Seurat(combined, species = "human")
...
## Save new objects
```{r save objects}
baseDir <- "~/updatedAtlas-hu/04_data_objects/02_QC_objects/"
