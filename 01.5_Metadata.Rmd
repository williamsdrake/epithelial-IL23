...
The objective of this notebook is to add metadata to seurat objects. For some reason, when using Rmarkdown, the Add_Sample_Meta fails, but runs fine when running code chunks individually.
...
# load packages
library(pacman)
p_load(Seurat, scCustomize, dplyr, GEOquery)
# load data
...
metaToAdd$ref <- "Williams 2021"
metaToAdd$source <- "GSE164241"
